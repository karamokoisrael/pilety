...
urlpatterns = [
    ...
    path('ac/api/', include('users.api_urls', namespace='users')),
    path('fn/api/', include('finance.api_urls', namespace='finance')),
    path('sh/api/', include('shipping.api_urls', namespace='shipping')),
