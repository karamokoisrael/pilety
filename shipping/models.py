...
class Shipment(models.Model):
    ...
    line_haul_rate = models.DecimalField(blank=True, null=True, max_digits=4, max_length=6)
    unloading_fee = models.DecimalField(blank=True, null=True, max_digits=4, max_length=6)
    detention_fee = models.DecimalField(blank=True, null=True, max_digits=4, max_length=6)
    layovers_fee = models.DecimalField(blank=True, null=True, max_digits=4, max_length=6)
    other_charges = models.DecimalField(blank=True, null=True, max_digits=4, max_length=6)
    total_rates = models.DecimalField(blank=True, null=True, max_digits=4, max_length=6)
